...
class Step1Calidad extends Component {
  state = {
    openDate1: false,
    date: '',
    sofya: '',
  ...
  render() {
    ...
    console.log('pathCrono', pathCrono);
    return (
      <SafeAreaView style={{flex: 1}}>
        <KeyboardAwareScrollView>
          ...
          <View style={{flex: 1}}>
            ...
            />
            <Text style={generalStyles.textTitle}>Supervisor de UC</Text>
            <TextInput
              style={userStyles.textInput}
              placeholder={'Escriba el Supervisor de UC'}
              placeholderTextColor="rgb(113, 109, 109)"
              value={supervisorUC}
              onChangeText={text => this.setttingParam('supervisorUC', text)}
            />

            <Text style={generalStyles.textTitle}>Asistente de UC</Text>
            <TextInput
              style={userStyles.textInput}
              placeholder={'Escriba el Asistente de UC'}
              placeholderTextColor="rgb(113, 109, 109)"
              value={asistenteUC}
              onChangeText={text => this.setttingParam('asistenteUC', text)}
            />
          ...
          <View
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                console.log('beforeDssata', beforeData);
                this.props.navigation.navigate('step2Calidad', {
                  beforeData,
                });
              }}>
...
export default connect(mapStateProps, {logOut})(Step1Calidad);
